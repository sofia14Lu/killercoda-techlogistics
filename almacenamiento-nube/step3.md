...
Implementar un script en Bash que:

- Tome los archivos de la carpeta `/data/backups`
- Los comprima en formato `.zip`
- Suba el archivo comprimido al bucket S3 creado
- Elimine los archivos locales después de una subida exitosa
